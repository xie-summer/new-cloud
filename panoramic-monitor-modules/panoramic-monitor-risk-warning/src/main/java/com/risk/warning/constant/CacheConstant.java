...
public abstract class CacheConstant {
	...
	public static final String KEY_CUR_MPI_CACHENAME = "key_mobile_cur_mpi_list";	//ӰԺӰƬڻȡƬ
	public static final String KEY_RECENTLYGETPOINT = "recentlygetpoint";	//ȡûList
	public static final String KEY_LUCKGETPOINT = "luckgetpoint"; //ȡ5ûList
	public static final String KEY_HONG_BAO_COMMENT_COUNT = "hongbao_commentcount";	//ȡû
	public static final String KEY_HONG_BAO_COMMENT_LIST = "hongbao_commentlist";		//ȡûһҳlist
	...
	public static final String KEY_SPORTITEM_ITEMID_PLAYDATE_COUNT = "key_sportitem_itemid_playdate_count"; //˶Ŀݿ
	...
	public static final String KEY_OPIGATHER = "key_opigather_"; //ռID
	...
	public static final String KEY_HOTSPOT_CINEMA_MPI_CACHE = "hotspot_cinema_mpi_cache_new";//ųλ
	public static final String KEY_USER_UNPAY_COUNT = "key_user_unpay_count";//ûֻµδ֧
	public static final String KEY_USER_ORDER_REMOTE_LOCKED = "key_user_order_remote_locked";//ûѾȥԶ
	...
	public static final String KEY_COMMONSERVICE_GETGEWACOMMENDLIST = "key_app_commonservice_getgewacommendlistxx";	// ҳƼλ
	public static final String KEY_APP_GETPHONEADVERTLIST = "key_app_phoneadvertlist_a2sdas";	// ֻҳƼ
	
	public static final String KEY_APP_GETGOODSMAP_BYMOVIEID = "key_app_goodsmap_bymovieid";
	
	public static final String KEY_FUTUREMOVIELIST = "getFutureMovieListEnddateFromMaxNums";	// ӳӰƬ
	
	public static final String KEY_FILMFEST_BEIJING5 = "filmfest_beijing5";	// 챱Ӱ
}
